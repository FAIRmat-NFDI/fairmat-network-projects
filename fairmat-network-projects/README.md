# fairmat-network-projects

NOMAD plugin for managing network project information and tracking interactions and collaborations with FAIRmat and NOMAD.
...
```sh
git clone https://github.com/FAIRmat/fairmat-network-projects.git
cd fairmat-network-projects
...
| Name | E-mail     |
|------|------------|
| Ahmed E. Mansour | [amansour@physik.hu-berlin.de](mailto:amansour@physik.hu-berlin.de)
